     ...
     <table class="table table-bordered">
      ...
      <tbody>
       <tr>
        <th>Employee Name</th>
        <td>
          <input type="text" name="name" id="name" onkeyup="validFname()" />
      ...
      <tr>
        <th>Designation</th>
        <td>
          <input type="text" name="designation" id="designation" onkeyup="validDesig()"/>
      ...
      <tr>
        <th>Reporting Person</th>
        <td>
          <input type="text" name="reporting_person" id="reporting_person" onkeyup="validrepo()"/>
